...
if (isset($_POST["submit"])) {
    ...
    $subcategoryQuery = "SELECT subcat_id FROM prodsubcat WHERE subcat_name = '$subcat_name'";
        ...
        <div class="row m-5">
            <div class="col-lg-12">
                <div class="card bg-white p-5">
                    <h2 class="mb-4">Product Update Form</h2>
                    <form method="POST" enctype="multipart/form-data" class="p-5">
                        <?php
                            include("config.php");
                            $id = $_GET['update'];
                            $productQuery = "SELECT * FROM products WHERE prod_id = '$id'";
                        ...
                        <div class="mb-3">
                            ...
                            <select class="default-select form-control wide mb-3" name="subcat_name">
                                ...
                                <?php
                                $subcategoryQuery = "SELECT * FROM prodsubcat";
                                $subcategoryResult = $conn->query($subcategoryQuery);
