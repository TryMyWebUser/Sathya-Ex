...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $updateSql = "UPDATE about_images SET experience = '$experience', heading = '$head', description = '$des'";
    if ($img1 !== "") {
        $updateSql .= ", img1 = '$img1'";
    }
    if ($img2 !== "") {
        ...
        <div class="card no-border m-b-30">
            ...
            <div class="card-body m-t-15">
                <?php
                    ...
                    $productQuery = "SELECT * FROM about_images WHERE id = '$imageid'";
