...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertSql = "INSERT INTO about_page (experience, img1, img2, img3, heading, heading2, description) 
    VALUES ('$experience', '$img1', '$img2', '$img3', '$head', '$head2', '$des')";
        ...
        if ($img1 != "" && move_uploaded_file($fname1, 'about_images/' . $img1) &&
            ...
            echo "<script>
                Swal.fire({
                    ...
                    window.location.href = 'abtimgadd2.php';
                });
            </script>";
        } else {
            echo "<script>
