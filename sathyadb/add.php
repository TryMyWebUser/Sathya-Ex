...
if (isset($_POST["submit"])) {
    ...
    $categoryQuery = "SELECT id FROM category WHERE cat_name = '$categoryName'";
    ...
    if ($categoryResult && $categoryResult->num_rows > 0) {
        ...
        $subcatQuery = "SELECT subcat_id FROM prodsubcat WHERE subcat_name = '$subcat_name'";
        ...
        if ($subcatResult && $subcatResult->num_rows > 0) {
            ...
            $insertSql = "INSERT INTO products (name, description, read_more, cat_id, cat_name, subcat_id, subcat_name) 
        ...
        <div class="card no-border m-b-30">
            ...
            <div class="card-body m-t-15">
                <form method="POST" enctype="multipart/form-data">
                    <?php
                    include("config.php");
                    $categoryQuery = "SELECT id, cat_name FROM category";
                    $categoryResult = $conn->query($categoryQuery);
                    ?>
                    ...
                    <div class="position-relative form-group">
                        <?php
                    include("config.php");
                    $categoryQuery = "SELECT subcat_id, subcat_name FROM prodsubcat";
                    $categoryResult = $conn->query($categoryQuery);
                    ?>
